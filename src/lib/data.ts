...
export const calendarEvents = [
  ...
  // Ajout des événements du 25, 26, 27 septembre
  {
    title: "Math",
    allDay: false,
  ...
  // Semaine d'octobre 1 - 31 (chaque jour d'octobre avec le même format)
  {
    title: "Math",
    allDay: false,
  ...
  // Continuer pour chaque jour et chaque heure de cours sur octobre et décembre...
];
